...
public class FabricanteBean {
	...
	public void salvar() {
		try {
			...
			FacesUtil.adicionarMsgErro("Ocorreu um erro ao tentar Cadastrar um Fabricante" + ex.getMessage());
		}
	}
	...
	public void carregarPesquisa() {
		...
		try {
			...
			FacesUtil.adicionarMsgErro("Ocorreu um erro ao tentar listar os Fabricantes" + ex.getMessage());
		}
	...
	public void carregarCadastro() {
		try {
			...
			FacesUtil.adicionarMsgErro("Ocorreu um erro ao tentar obter os dados do Fabricante" + ex.getMessage());
		}
	}
	...
	public void excluir() {
		try {
			...
			FacesUtil.adicionarMsgErro("Ocorreu um erro ao tentar remover um Fabricante" + ex.getMessage());
		}
	}
	...
	public void editar() {
		try {
			...
			FacesUtil.adicionarMsgErro("Ocorreu um erro ao tentar editar os dados do Fabricante" + ex.getMessage());
		}
	}
